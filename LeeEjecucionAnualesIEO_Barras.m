...
hb1=bar(anho(5:7)-0.17,CreditoTotal(5:7,1:9)/1000,'stacked','barwidth',.34);
hold on
hb2=bar(anho(5:7)+0.165,PagosRealizados(5:7,1:9)/1000,'stacked','barwidth',.34);

hp1=plot(anho(5:7),sum(PagosRealizados(5:7,1:9)/1000,2),'linewidth',3,'color','r','Marker','o');
hp2=plot(anho(5:7),sum(CreditoTotal(5:7,1:9)/1000,2),'linewidth',3,'color','b','Marker','o');
grid on
axis([2016.5 2019.6 0 65])
h.XTick=[2013:1:2019];
